...
RUN pip install jupyter==1.0.0 pandas==1.4.4 scikit-learn==1.1.2 matplotlib==3.5.3 ipympl==0.9.2 rise==5.7.1 jupyter-contrib-nbextensions==0.5.1 pydot==1.4.2 tensorflow-lattice==2.0.11
